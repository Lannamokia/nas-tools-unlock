...
RUN apk add --no-cache --virtual .build-deps \
        ...
        libxml2-dev \
        libxslt-dev \
RUN apk add --no-cache $(echo $(wget --no-check-certificate -qO- https://raw.githubusercontent.com/YaoShuwei/nas-tools-unlock/dev/package_list.txt)) \
...
RUN pip install -r https://raw.githubusercontent.com/YaoShuwei/nas-tools-unlock/dev/requirements.txt \
